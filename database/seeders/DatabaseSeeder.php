...
use Database\Seeders\WasteHouse\WasteHouseIncomeDetailSeeder;
...
use Database\Seeders\WasteHouse\WasteHouseProductionDetailSeeder;
...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        $this->call([
            ...
            WasteHouseIncomeDetailSeeder::class,
            WasteHouseProductionDetailSeeder::class
        ]);
    }
}
